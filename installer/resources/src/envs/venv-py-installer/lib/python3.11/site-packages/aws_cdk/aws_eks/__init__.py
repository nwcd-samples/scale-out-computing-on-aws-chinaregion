...
class CfnPodIdentityAssociation(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param cluster_name: The cluster that the pod identity association is created for.
        :param namespace: The Kubernetes namespace that the pod identity association is created for.
