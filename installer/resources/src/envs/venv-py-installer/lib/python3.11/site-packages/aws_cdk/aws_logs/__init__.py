    ...
    def __init__(
        ...
        *,
        ...
        props = CfnDeliveryDestinationProps(
            name=name, destination_resource_arn=destination_resource_arn, tags=tags
        )
...
class CfnLogAnomalyDetector(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param account_id: Account ID for owner of detector.
        :param anomaly_visibility_time: 
        :param detector_name: Name of detector.
        :param evaluation_frequency: How often log group is evaluated.
        :param filter_pattern: 
        :param kms_key_id: The Amazon Resource Name (ARN) of the CMK to use when encrypting log data.
        :param log_group_arn_list: List of Arns for the given log group.
        '''
        if __debug__:
