...
class CfnRepositoryLink(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param connection_arn: The Amazon Resource Name (ARN) of the CodeStarConnection. The ARN is used as the connection reference when the connection is shared between AWS services.
        :param owner_id: the ID of the entity that owns the repository.
        :param repository_name: The repository for which the link is being created.
        :param encryption_key_arn: The ARN of the KMS key that the customer can optionally specify to use to encrypt RepositoryLink properties. If not specified, a default key will be used.
        :param tags: Specifies the tags applied to a RepositoryLink.
        '''
        if __debug__:
...
class CfnSyncConfiguration(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param branch: The name of the branch of the repository from which resources are to be synchronized,.
        :param config_file: The source provider repository path of the sync configuration file of the respective SyncType.
        :param repository_link_id: A UUID that uniquely identifies the RepositoryLink that the SyncConfig is associated with.
        :param resource_name: The name of the resource that is being synchronized to the repository.
        :param role_arn: The IAM Role that allows AWS to update CloudFormation stacks based on content in the specified repository.
        :param sync_type: The type of resource synchronization service that is to be configured, for example, CFN_STACK_SYNC.
        '''
        if __debug__:
