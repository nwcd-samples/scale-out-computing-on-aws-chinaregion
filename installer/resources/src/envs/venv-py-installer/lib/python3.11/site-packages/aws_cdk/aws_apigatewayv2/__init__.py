...
```python
from aws_cdk_lib.aws_apigatewayv2_integrations import HttpUrlIntegration, HttpLambdaIntegration
...
```python
from aws_cdk_lib.aws_apigatewayv2_integrations import HttpUrlIntegration
...
from aws_cdk_lib.aws_apigatewayv2_integrations import HttpLambdaIntegration
...
```python
from aws_cdk_lib.aws_apigatewayv2_integrations import WebSocketLambdaIntegration
...
class MappingValue(
    ...
    Example::
        ...
        mapping_value = apigatewayv2.MappingValue.context_variable("variableName")
    '''
...
class HttpNoneAuthorizer(
    ...
    Example::
        ...
        http_none_authorizer = apigatewayv2.HttpNoneAuthorizer()
    '''
